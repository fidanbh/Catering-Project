...
const OrganizationKitchen = () => {
  return (
    <section className={styles.organizationKitchen}>
      <div className={styles.firstPartStyle}>
        ...
        <div className={styles.firstPart}>
          <div className={styles.firstPartDiv}>
            <p>
              <span>
                Организация питания на предприятии по типу раздаточных – один из
                основополагающих моментов в устройстве работ фирмы, проведении
                различных внутренних мероприятий. Полноценный кейтеринг
                позволяет не только подкрепиться, но и пообщаться с коллегами и
                партнерами в непринужденной обстановке. Компания «Общепит 39»
                занимается организацией питания для сотрудников в различных
                форматах. Организуем доставку корпоративных обедов для офисов и
                мероприятий любого масштаба. Наше предложение включает в себя:
              </span>
              <ul>
                <li>
            ...
            <p>
              <span className={styles.firstPartDivText}>
                Услуги питания от компании «Вкус Кейтеринг» станут оптимальным выбором
                для:
              </span>
              <ul>
                <li>Руководителей, владельцев крупных фирм, организаций.</li>
                <li>Предприятий, работающих по сложному графику.</li>
                <li>Компаний, организующих семинары, тренинги, конференции.</li>
              </ul>
            </p>
          </div>
        ...
        <div className={styles.posledniyeChastiFirst}>
          <div>
            <p className={styles.textStyle1}>
              ...
              работают по одному графику. Потому что столовая обычно открывается
              только в обед, а потом закрывается.
            </p>
          </div>
          <div>
        ...
        <div className={styles.posledniyeChastiFirst}>
          <div className={styles.posledniyeChastitext}>
            <p className={styles.textStyle}>
              ...
              — важное направление деятельности нашей компании «Общепит 39». Мы
              предлагаем несколько форматов, в том числе организацию столовой,
              буфет и доставку готовых блюд. С точки зрения ГОСТ 30389-2013
              буфет — это форма организации общественного питания, которая
              предполагает продажу несложных в приготовлении блюд (например, из
              полуфабрикатов высокой готовности), выпечки и кондитерских
              изделий. С технологической точки зрения понадобится комплекс, в
              который входят несколько единиц оборудования, предназначенного для
              непродолжительного хранения горячих или холодных блюд и напитков.
            </p>
          </div>
      ...
      <div>
        <h1 className={styles.dostavkaTittle}>
          <span className={styles.dostavkaSpan}>Какое оборудование</span> может
          потребоваться
        </h1>
        <span>
          Обычно оборудование подбирают с учетом того, какое меню предусмотрено,
          сколько посетителей <br />
          ...
          <div className={styles.partsBox}>
            <div>
              ...
              <div className={styles.secondDiv}>
                {" "}
                <p>
                  <span className={styles.secondText}>Витрины для выпечки</span>
                </p>
              </div>
            </div>
          </div>
            ...
            <div className={styles.secondDiv}>
              ...
              <p>
                <span className={styles.secondText}>
                  ...
                  также могут быть установлены дополнительные приборы, например,
                  сокоохладитель.
                </span>
              </p>
            </div>
      ...
      <div className={styles.nashiPreimushestva}>
        <h1 className={styles.tittle}>
          <span className={styles.textColor}>Правила организации</span> столовой
          и буфета
        </h1>
