  ...
  return (
    <section>
      <div className={styles.firstPartStyle}>
        ...
        <div className={styles.firstPart}>
          ...
          <div className={styles.firstPartDivImage}>
            <img src="/img/kuricha.jpg" className={styles.firstPartImage}></img>
          </div>
        </div>
      </div>
            ...
            <div className={styles.partsBox}>
              <div key={item.id}>
                ...
                <div className={styles.secondDiv}>
                  {" "}
                  <p>
                    <span className={styles.secondText}>{item.bolderText}</span>
                    <p>{item.text}</p>
                  </p>
                </div>
              </div>
            ...
            <div className={styles.secondDiv}>
              ...
              <p>
                <span className={styles.secondText}>
                  ...
                  работаем в этой отрасли с 2009 года и знаем, какую важную роль
                  играет корпоративное питание.
                </span>
              </p>
            </div>
          </div>
      ...
      <div className={styles.posledniyeChasti}>
        ...
        <span>
          Существует несколько вариантов, выбор конкретного зависит от ситуации
          на предприятии. Наша компания «Вкус Кейтеринг» предлагает:
        </span>
      ...
      <div className={styles.nashiPreimushestva}>
        ...
        <p>
          Наша компания «Вкус Кейтеринг» сможет организовать корпоративное питание в любой
          точке Калининградской области, в том числе и на отдаленных площадках
          (например, там, где ведется строительство).
        </p>
          ...
          <div className={styles.dostavkaLastPartFirst}>
            ...
            {pochemuNujnokNam.map((item, index) => (
              <ul key="index" className={styles.noSpacing}>
                <li>
                    <span>{item.first}</span><span>{item.second}</span>
                </li>
              </ul>
            ))}
          </div>
