        ...
        <div className={styles.firstPart}>
          <div className={styles.firstPartDiv}>
            ...
            <p>
              ...
              норм. Но выход есть и в этой ситуации. Чтобы организовать вкусный,
              полезный и, конечно же, горячий обед на предприятии, вам
              достаточно позвонить нам. Мы возьмем на себя все текущие вопросы и
              предоставим вам комфортные условия для сотрудничества. Это:
              <ul>
                <li>
          ...
          <div className={styles.firstPartDivImage}>
            <img src="/img/yeda.jpg" className={styles.firstPartImage}></img>
          </div>
        </div>
      </div>
      <Button
            ...
            {dostavkaDataSecond.map((item) => (
              <ul key={item.id} className={styles.obedKafeteriyUl}>
                <li className={styles.obedKafeteriyDisplay}>
                  <div>{<MdDone className={styles.iconStyleObedKafeteriy}/>}</div>
                  <div>{item.text}</div>
                </li>
              </ul>
            ))}
          ...
          <div className={styles.posledniyeChastitext}>
            ...
            <p className={styles.textStyle}>
              ...
              <ul className={styles.noSpacing}>
                ...
                <li>
                  какой вариант меню вы предпочитаете — выбор отдельных блюд или
                  комплексные обеды (суп, мясное блюдо с гарниром и салат),
                  возможно, будут отдельные требования для вегетарианцев;
                </li>
                <li>есть ли оборудованная столовая;</li>
                <li>
                  как работает предприятие, какой будет график работы (посменный
                  или нет).
                </li>
              </ul>
            </p>
      ...
      <div className={styles.nashiPreimushestva}>
        ...
        <div className={styles.dostavkaLastPart}>
          <div className={styles.dostavkaLastPartFirst}>
            <p>
              Наша компания «Вкус Кейтеринг» предлагает услуги доставки питания в
              Калининграде по доступным ценам. Наши преимущества:
            </p>
          ...
          <div className={styles.dostavkaLastPartSecond}>
            <p>
              Все блюда готовятся в день доставки. Мы заботимся об их правильной
              упаковке, чтобы они сохранили свою свежесть и хранились при
              правильном температурном режиме. Также у нас можно дополнительно
              заказать одноразовую посуду для организации питания на отдаленных
              участках.
            </p>
          </div>
        </div>
