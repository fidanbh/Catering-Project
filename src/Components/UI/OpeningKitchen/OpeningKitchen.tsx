    ...
    <section className={styles.openingKitchen}>
      <div className={styles.firstPartStyle}>
        ...
        <div className={styles.firstPart}>
          <div className={styles.firstPartDiv}>
            <p>
              Полностью берем на себя функцию по организации питания и оснащению
              столовой. Вам больше не придется следить за квалификацией
              работников, разработкой, адаптацией и качеством меню. Это
              достигается путем передачи непрофильных активов под наше
              профессиональное управление. Благодаря опыту работы с крупными
              клиентами мы научились адаптировать и регламентировать на практике
              системы менеджмента качества продукции и сервиса, а также внедрить
              собственные наработки индивидуально под каждого клиента.
            </p>
            <p>
            ...
            <p>
              ...
              <ul>
                ...
                <li>
                  сокращение времени производства продукции благодаря повышению
          ...
          <div className={styles.firstPartDivImage}>
            <img
              src="https://i.hizliresim.com/eatpakr.jpg"
      ...
      <div>
        <h1 className={styles.tittle}>
          Чем удобен <span className={styles.textColor}>формат столовой?</span>
        </h1>
        ...
        <div className={styles.posledniyeChastiFirst}>
          <div className={styles.posledniyeChastitext}>
            ...
            <p className={styles.textStyle}>
              ...
              полноценный обеденный зал, площадь которого рассчитывается как 2,5
              кв. м на каждого сотрудника. Возрастут и расходы на электричество.
            </p>
          </div>
          <div className={styles.posledniyeChastiImage}>
            <img src="https://i.hizliresim.com/1in149c.png"></img>
          </div>
        </div>
        <div className={styles.posledniyeChastiFirst}>
          <div>
            <p className={styles.textStyle1}>
              ...
              производственных мощностях и затем доставляем на ваше предприятие
              в специальных термоконтейнерах. На месте нужно выстроить только
              состоящую из нескольких модулей раздаточную линию. <br />
              Преимущества этого варианта:
              <ul className={styles.noSpacing}>
                <li>
                ...
                <li>
                  небольшой расход электричества (только на модули с охлаждением
                  или подогревом);
                </li>
                <li>
          ...
          <div>
            <p className={styles.textStyle2}>
              <span className={styles.perviy}>Еще один вариант</span> — столовая
              доготовочного типа. Блюда в виде полуфабрикатов готовят на нашей
              фабрике-кухне, а на территории вашего предприятия их нужно только
              разогреть. Салаты и холодные закуски привозят уже в готовом виде
              или готовят в столовой — зависит от того, как устроено
              производство.
              <br />
              Преимущества этого варианта:
              <ul className={styles.noSpacing}>
            ...
            <div key={data.id} className={styles.partsBox}>
              <div>
                ...
                <div className={styles.secondDiv}>
                  {" "}
                  <p>
                    <span className={styles.secondText}>{data.firstSpan}</span>
                    {data.text}
                  </p>
                </div>
              </div>
